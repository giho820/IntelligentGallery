...
public class DiLabClassifierUtil {
    ...
    public static LinkedHashMap<Integer, String> classifySpecificImageFile(String inputText, Integer _DATA) {
        ...
        //중복 제거
//        + ") where not exists (select "+DatabaseConstantUtil.COLUMN_DID +" from "
//                + DatabaseConstantUtil.TABLE_INTELLIGENT_GALLERY_NAME
//                + " where "+ DatabaseConstantUtil.COLUMN_DID +" = "+_DATA +" and "+DatabaseConstantUtil.COLUMN_RANK +" = "+ 0
