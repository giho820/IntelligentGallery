 ...
 */
public class MoveActAdapter extends BaseAdapter {
    ...
    public MoveActAdapter(Activity activity, Context context, List<Album> _albums, int copyOrMove) {
...
//                    DebugUtil.showToast(mContext, "선택한 앨범의 경로 :: " + album.getPath());
                    Intent intent = new Intent(mContext, GalleryAct.class);
                    intent.putExtra("pathFromMoveAct", album.getPath());
