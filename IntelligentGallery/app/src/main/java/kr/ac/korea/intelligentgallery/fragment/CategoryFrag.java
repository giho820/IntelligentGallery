...
public class CategoryFrag extends ParentFrag implements OnBackPressedListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (clickedcId >= 0) {
            ...
            imagesInFolderHavingNotCorrectPath = FileUtil.createViewItems(clickedcId);
            imagesInFolder = FileUtil.createViewItemsHavingPath(mContext, imagesInFolderHavingNotCorrectPath);
        } else {
            DebugUtil.showDebug("CategoryFrag, onCreateView(), root path is null");
        }
...
//                return true;
            ...
            case R.id.action_sharing:
                DebugUtil.showToast(categoryAct, "공유하기");
                return true;
            ...
            case R.id.action_detail:
                DebugUtil.showToast(categoryAct, "세부정보보기");
