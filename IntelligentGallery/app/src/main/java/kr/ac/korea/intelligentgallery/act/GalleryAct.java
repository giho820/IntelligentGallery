...
//                    imageAdapter.notifyDataSetChanged();
    ...
    public class MatchingAsyncTask extends AsyncTask<Integer, String, Integer> {
        ...
        protected Integer doInBackground(Integer... params) {
            ...
            DiLabClassifierUtil.luceneKoInitializer.initialize(GalleryAct.this);
            ...
            for (int i = 0; i < sampleContentScoreDataMaps.size(); i++) {
                ...
                for (Integer key : sampleContentScoreDatas.keySet()) {
                    ...
                    matchingResult.add(sampleContentScoreData.getContentsID());
                }
            }
...
//                    DatabaseCRUD.deleteSpecificIdQuery(currentImageFileImage.getId());
//                    FileUtil.deleteImage(this, currentImageFileImage.getPath());
//                    imagesInSameFolder.remove(imagesInSameFolder.get(selectedPostion));
